...
const membershipData = [
    {
        ...
        benefits:[
            ...
            {
                icon:FaCheck,
                text:'Access to all gum facilities'
            },
            {
                icon:MdClose,
                text:'Diet plan incude'
            },
            {
                icon:FaCheck,
            ...
            return (
                <SwiperSlide key={index}>
                    <div className="border border-accent hover:bg-primary-300/80
                        ...
                        <div className="py-5 px-[60px] border-b border-accent">
                        ...
                        </div>                        <div className="py-[30px] px-[60px]"> 
                            ...
                            <p className="text-accent mb-5 flex gap-1 items-center">
                                <sup className="text-4xl">$</sup>
                                <strong className="text-6xl">{item.price}</strong>
                                <em className="self-end text-2xl">/month</em>
                            </p>

                            <CustomButton containerStyles="w-[196px] h-[52px]" text="Buy now"/>
